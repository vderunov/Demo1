...
describe('Show Chessboard', () => {
    ...
    describe('Error conditions', () => {
        ...
        it('Not enough parameters: (10, 10)', () => {
            assert.deepEqual(showChessBoard(10, 10), {
                status: 'failed',
                reason:
                    'Not enough parameters. Expected parameters: 1. Number, 2. Number, 3. String',
            });
        ...
        it('Not enough parameters: (10, *)', () => {
            assert.deepEqual(showChessBoard(10, '*'), {
                status: 'failed',
                reason:
                    'Not enough parameters. Expected parameters: 1. Number, 2. Number, 3. String',
            });
        ...
        it('Negative length: (-1, 10, *)', () => {
            assert.deepEqual(showChessBoard(-1, 10, '*'), {
                status: 'failed',
        ...
        it('Length = 0: (0, 10, *)', () => {
            assert.deepEqual(showChessBoard('0', 10, '*'), {
                status: 'failed',
        ...
        it('Width = 0: (10, 0, *)', () => {
            assert.deepEqual(showChessBoard(10, '0', '*'), {
                status: 'failed',
                reason: 'Length and width cannot be 0',
            });
        });
        ...
        it('Width and length must be equal: (7, 10, *)', () => {
            assert.deepEqual(showChessBoard(7, 10, '*'), {
                status: 'failed',
        ...
        it('Width and length must be equal: (10, 7, *)', () => {
            assert.deepEqual(showChessBoard(10, 7, '*'), {
                status: 'failed',
                reason: 'Width and length must be equal',
            });
        });
        ...
        it('Maximum board size 50 x 50. (55, 55, *)', () => {
            assert.deepEqual(showChessBoard(55, 55, '*'), {
                status: 'failed',
        ...
        it('Length and width must be even: (3, 3, *)', () => {
            assert.deepEqual(showChessBoard(3, 3, '*'), {
                status: 'failed',
