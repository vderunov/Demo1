  ...
  describe('Show Chessboard', () => {
    ...
    describe('Error conditions', () => {
      const error = [
        ...
        {
          description: 'Expected only one character (example: * ): (10, 10, **)',
          arguments: [10, 10, '**'],
          result: {
            status: 'failed',
        ...
        {
          description: 'The first and second parameters must be numbers: (10, *, *)',
          arguments: [10, '*', '*'],
          result: {
            status: 'failed',
