...
const test5 = function makeTestsForTask5(assert) {
  describe('Lucky tickets', () => {
    ...
    const valid = [
      {
        description: 'With values: min: 233456, max: 554321; result: easy: 19536, hard: 18528',
        arguments: [{
          min: '233456',
          max: '554321',
        }],
      ...
      {
        description: 'With values: min: 000100, max: 500500; result: easy: 19536, hard: 18528',
        arguments: [{
          min: '000100',
          max: '500500',
        }],
      ...
      {
        description: 'With values: min: 000000, max: 999999; result: easy: 55252, hard: 55252',
        arguments: [{
          min: '000000',
          max: '999999',
        }],
      ...
      {
        description: 'With values: min: 123456, max: 654321; result: easy: 31607, hard: 30213',
        arguments: [{
          min: '123456',
          max: '654321',
        }],
    ...
    valid.forEach((el) => {
      it(el.description, () => {
        assert.deepEqual(
          luckyTicketCounting(...el.arguments),
          el.result,
        );
      });
    });
    ...
    describe('Error conditions', () => {
      const error = [
        ...
        {
          description: 'Only numbers expected: ({ min: 123456 , max:1#*&$Q#  })',
